...
sources: ["mcp-authorization-security-considerations", "mcp-security-best-practices", "owasp-llm-top-10-2025"]
related: ["token-audience-binding", "token-passthrough", "mcp-authorization", "security-considerations", "oauth-2-1", "machine-identity", "public-vs-confidential-client", "session-hijacking", "scope-selection-strategy", "system-prompt-leakage"]
