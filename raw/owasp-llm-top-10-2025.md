...
- **File:** `owasp-llm-top-10-2025.pdf` — 45 pages, PDF 1.4, 8,768,341 bytes
- **License:** Creative Commons Attribution-ShareAlike 4.0 (CC BY-SA 4.0). Redistribution and adaptation are permitted with attribution and share-alike; see https://creativecommons.org/licenses/by-sa/4.0/legalcode. This license governs the PDF and overrides the "licensing varies per file" default noted in `raw/README.md`; the repository's own MIT `LICENSE` does not apply to it.
- **Revision history (per the document):** v1.0 2023-08-01 · v1.1 2023-10-16 · v2025 2024-11-18.
